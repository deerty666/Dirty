...
// الإعدادات والثوابت
// =====================================================================
const BASE_PATH = '/Dirty/'; // ✨ تم التعديل ليطابق اسم المستودع (Dirty)
let cart = [];
...
function generateWhatsAppMessage() {
    ...
    message += `*طريقة الاستلام*: ${orderMethod === 'delivery' ? 'توصيل (رسوم: 5 ريال)' : 'استلام من المطعم (مجاني)'}\n`;
